	...
	var webpackConfig = {
		...
		resolve: {
			...
			alias: {
				...
				'animation.gsap': path.resolve('./src/javascript/vendor/scrollmagic/plugins/animation.gsap.js'),
				'indicators': path.resolve('./src/javascript/vendor/scrollmagic/plugins/debug.addIndicators.js')
			}
		},
		// node: {
		//	 fs: "empty"
